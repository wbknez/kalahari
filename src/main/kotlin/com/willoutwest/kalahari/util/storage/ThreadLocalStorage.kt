 ...
 * arbitrary type with a thread-specified identifier.
 *
 * This implementation is meant to rectify one of the more prominent issues
 * with Java's [ThreadLocal] class: the inability to explicitly control the
