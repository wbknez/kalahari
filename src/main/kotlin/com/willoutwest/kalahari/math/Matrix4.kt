 ...
 */
class Matrix4(t00: Float = 1f, t01: Float = 0f,
    ...
    operator fun div(scalar: Float): Matrix4 {
        ...
        return Matrix4(this.t00 * inv, this.t01 * inv,
    ...
    operator fun minus(mat: Matrix4): Matrix4 =
        Matrix4(this.t00 - mat.t00, this.t01 - mat.t01,
    ...
    override fun set(t00: Float, t01: Float, t02: Float, t03: Float,
        ...
        super.set(t00, t01, t02, t03, t10, t11, t12, t13,
                  t20, t21, t22, t23, t30, t31, t32, t33) as Matrix4

    override fun set(array: FloatArray): Matrix4 = super.set(array) as Matrix4

    override fun set(table: Table4?): Matrix4 = super.set(table) as Matrix4

    operator fun times(scalar: Float): Matrix4 =
        Matrix4(this.t00 * scalar, this.t01 * scalar,
    ...
    operator fun times(mat: Matrix4): Matrix4 =
        Matrix4(this.t00 * mat.t00 + this.t01 * mat.t10 +
     ...
     */
    fun transpose(): Matrix4 = Matrix4(this.t00, this.t10, this.t20, this.t30,
