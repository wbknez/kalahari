...
/**
 * Represents a mechanism for generating sample points from a unit square, or
 * grid.
 *
 ...
 * types of geometriy - specifically, disks, hemispheres, and spheres - but
...
interface SampleGenerator {
     ...
     */
    fun generate(numSamples: Int, numSets: Int): SampleBasis2
}
