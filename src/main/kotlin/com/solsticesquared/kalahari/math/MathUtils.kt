...
sealed class MathUtils {
    ...
    companion object {
         ...
         */
        fun csc(angle: Float): Float {
            return 1f / Math.sin(angle.toDouble()).toFloat()
        }
        ...
        fun fourKnotSpline(x: Float, kns: FloatArray): Float {
            return fourKnotSpline(x, kns[0], kns[1], kns[2], kns[3])
        }
         ...
         */
        fun pow(x: Float, exp: Float): Float {
            return Math.pow(x.toDouble(), exp.toDouble()).toFloat()
        }
         ...
         */
        fun sec(angle: Float): Float {
            return 1f / Math.cos(angle.toDouble()).toFloat()
        }
