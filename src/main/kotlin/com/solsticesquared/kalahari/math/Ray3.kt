 ...
 *           The starting point.
 */
class Ray3(var dir: Vector3 = Vector3.Unit.clone(),
           var origin: Point3 = Point3.Zero.clone()) : Cloneable {
     ...
     */
    constructor(ray: Ray3?) : this(ray!!.dir, ray.origin)
     ...
     */
    fun projectAlong(t: Float): Point3 =
        Point3(
